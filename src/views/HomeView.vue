            ...
            <div class="products-wrapper" id="rests-container">
                ...
                >
                    <div class="products-card__image">
                        <img :src="getUrl(rest.image)" alt="pizza_plus" />
                    </div>
                    <div class="products-card__description">
                        <div class="products-card__description-row">
                            <h4 class="product-card--description--title">
                                {{ rest.title }}
                            </h4>
                            <div class="product-card--description--badge">
                                {{ rest.time }} мин
                            </div>
                        </div>
                        <div class="products-card__description-row">
                            <div class="products-card__description-info">
                                <div
                                    class="products-card__description-info--rating"
                                >
                                    <img
                                ...
                                <div
                                    class="products-card__description-info--price"
                                >
                                    От {{ rest.price }} ₽
                                </div>
                                <div
                                    class="products-card__description-info--group"
                                >
                                    {{ rest.type }}
                                </div>
                            </div>
